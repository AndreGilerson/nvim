...
require("config.diagnostics") -- upstream diagnostic autocmd leak workaround, must precede any LSP
require("config.writing") -- spell setup, Vale ruleset path, :DictSync wordlist
